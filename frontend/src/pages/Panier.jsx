...
import saladeexo from "../assets/img/salade-exotique.jpg";
...
function Panier() {
  ...
  return (
    <div className="flex flex-col justify-between items-center h-full w-full">
      ...
      />
      <div className="px-4 flex flex-col h-full w-full items-center">
        <div className="flex flex-col h-full w-11/12 items-center ">
          <div className="flex flex-row w-full justify-evenly items-center mt-5">
            <button
              type="button"
          ...
          <div className="flex flex-col">
            <div className="bg-white font-sans rounded-xl">
              <div className="flex flex-row flex-nowrap justify-between">
                <div className="flex font-semibold items-start">
                  ...
                  />
                  <div className="my-4 flex flex-col justify-between">
                    <h3 className="text-sm ">Salade Exotique</h3>
                    <div className="flex flex-row justify-start text-base my-4">
                      <div className="button bg-brown text-white rounded-3xl whitespace-nowrap px-3  py-1">
                        <button
                          className="px-1 md:px-2 md:pl-3"
            ...
            <div className="flex flex-col items-center my-5">
              ...
              <div className="flex items-center">
                <p className="font-sans text-brown text-4xl font-semibold">
                  25
                </p>
